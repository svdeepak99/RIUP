...
class trackmoves
{
  ...
  float currentangle;
  float distance;
  float points[10][3]={ {-250,-250,FRONT} , {-250,250,FRONT} , {250,250,FRONT} , {250,-250,FRONT} , {-250,-250,FRONT} };
  int n=5,i=0;
...
//    Serial.print((X+_X)/2);Serial.print('\t');Serial.println((Y+_Y)/2);//Serial.print('\t');Serial.print(_X);Serial.print('\t');Serial.println(_Y);//Serial.print('\t');Serial.println(t1f.x);//Serial.print('\t');Serial.print(f1f);Serial.print('\t');Serial.println(f2f);
